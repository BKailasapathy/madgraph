...
C     
C     Process: g g > uv uv~ WEIGHTED<=2 @1
...
C     ----------
     ...
     $   , ZERO)
      ...
      CALL VVV1P0_1(W(1,1),W(1,2),GC_10,ZERO, FK_ZERO,W(1,3))
C     Amplitude(s) for diagram number 1
      CALL FFV1_0(W(1,4),W(1,5),W(1,3),GC_11,AMP(1))
      CALL FFV1_1(W(1,5),W(1,1),GC_11,MDL_MUV, FK_MDL_WUV,W(1,3))
C     Amplitude(s) for diagram number 2
      CALL FFV1_0(W(1,4),W(1,3),W(1,2),GC_11,AMP(2))
      CALL FFV1_2(W(1,4),W(1,1),GC_11,MDL_MUV, FK_MDL_WUV,W(1,3))
C     Amplitude(s) for diagram number 3
      CALL FFV1_0(W(1,3),W(1,5),W(1,2),GC_11,AMP(3))
