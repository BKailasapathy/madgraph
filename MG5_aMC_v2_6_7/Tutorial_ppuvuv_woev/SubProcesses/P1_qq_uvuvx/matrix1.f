...
C     ----------
     ...
     $   , ZERO)
      ...
      CALL OXXXXX(P(0,3),MDL_MUV,NHEL(3),+1*IC(3),W(1,3))
      CALL IXXXXX(P(0,4),MDL_MUV,NHEL(4),-1*IC(4),W(1,4))
      CALL FFV1P0_3(W(1,1),W(1,2),GC_11,ZERO, FK_ZERO,W(1,5))
C     Amplitude(s) for diagram number 1
      CALL FFV1_0(W(1,4),W(1,3),W(1,5),GC_11,AMP(1))
      CALL FFS2_3(W(1,1),W(1,3),GC_72,MDL_MPE2, FK_MDL_WPE2,W(1,5))
C     Amplitude(s) for diagram number 2
      CALL FFS1_0(W(1,4),W(1,2),W(1,5),GC_72,AMP(2))
      CALL FFS2_3(W(1,1),W(1,3),GC_71,MDL_MPE1, FK_MDL_WPE1,W(1,5))
C     Amplitude(s) for diagram number 3
      CALL FFS1_0(W(1,4),W(1,2),W(1,5),GC_71,AMP(3))
