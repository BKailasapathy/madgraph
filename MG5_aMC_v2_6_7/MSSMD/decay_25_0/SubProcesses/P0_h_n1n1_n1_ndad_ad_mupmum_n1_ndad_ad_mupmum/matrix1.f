...
C     
C     Process: h > n1 n1 NP<=4
C     *   Decay: n1 > nd ad NP<=4 WEIGHTED<=2
C     *     Decay: ad > mu+ mu- NP<=4 WEIGHTED<=2
C     *   Decay: n1 > nd ad NP<=4 WEIGHTED<=2
C     *     Decay: ad > mu+ mu- NP<=4 WEIGHTED<=2
C     
      USE DISCRETESAMPLER
...
C     
      ...
      DATA (NHEL(I,   1),I=1,7) / 0,-1, 1,-1,-1, 1,-1/
      DATA (NHEL(I,   2),I=1,7) / 0,-1, 1,-1,-1, 1, 1/
      DATA (NHEL(I,   3),I=1,7) / 0,-1, 1,-1,-1,-1,-1/
      DATA (NHEL(I,   4),I=1,7) / 0,-1, 1,-1,-1,-1, 1/
      DATA (NHEL(I,   5),I=1,7) / 0,-1, 1,-1, 1, 1,-1/
      DATA (NHEL(I,   6),I=1,7) / 0,-1, 1,-1, 1, 1, 1/
      DATA (NHEL(I,   7),I=1,7) / 0,-1, 1,-1, 1,-1,-1/
      DATA (NHEL(I,   8),I=1,7) / 0,-1, 1,-1, 1,-1, 1/
      DATA (NHEL(I,   9),I=1,7) / 0,-1, 1, 1,-1, 1,-1/
      DATA (NHEL(I,  10),I=1,7) / 0,-1, 1, 1,-1, 1, 1/
      DATA (NHEL(I,  11),I=1,7) / 0,-1, 1, 1,-1,-1,-1/
      DATA (NHEL(I,  12),I=1,7) / 0,-1, 1, 1,-1,-1, 1/
      DATA (NHEL(I,  13),I=1,7) / 0,-1, 1, 1, 1, 1,-1/
      DATA (NHEL(I,  14),I=1,7) / 0,-1, 1, 1, 1, 1, 1/
      DATA (NHEL(I,  15),I=1,7) / 0,-1, 1, 1, 1,-1,-1/
      DATA (NHEL(I,  16),I=1,7) / 0,-1, 1, 1, 1,-1, 1/
      DATA (NHEL(I,  17),I=1,7) / 0,-1,-1,-1,-1, 1,-1/
      DATA (NHEL(I,  18),I=1,7) / 0,-1,-1,-1,-1, 1, 1/
      DATA (NHEL(I,  19),I=1,7) / 0,-1,-1,-1,-1,-1,-1/
      DATA (NHEL(I,  20),I=1,7) / 0,-1,-1,-1,-1,-1, 1/
      DATA (NHEL(I,  21),I=1,7) / 0,-1,-1,-1, 1, 1,-1/
      DATA (NHEL(I,  22),I=1,7) / 0,-1,-1,-1, 1, 1, 1/
      DATA (NHEL(I,  23),I=1,7) / 0,-1,-1,-1, 1,-1,-1/
      DATA (NHEL(I,  24),I=1,7) / 0,-1,-1,-1, 1,-1, 1/
      DATA (NHEL(I,  25),I=1,7) / 0,-1,-1, 1,-1, 1,-1/
      DATA (NHEL(I,  26),I=1,7) / 0,-1,-1, 1,-1, 1, 1/
      DATA (NHEL(I,  27),I=1,7) / 0,-1,-1, 1,-1,-1,-1/
      DATA (NHEL(I,  28),I=1,7) / 0,-1,-1, 1,-1,-1, 1/
      DATA (NHEL(I,  29),I=1,7) / 0,-1,-1, 1, 1, 1,-1/
      DATA (NHEL(I,  30),I=1,7) / 0,-1,-1, 1, 1, 1, 1/
      DATA (NHEL(I,  31),I=1,7) / 0,-1,-1, 1, 1,-1,-1/
      DATA (NHEL(I,  32),I=1,7) / 0,-1,-1, 1, 1,-1, 1/
      DATA (NHEL(I,  33),I=1,7) / 0, 1, 1,-1,-1, 1,-1/
      DATA (NHEL(I,  34),I=1,7) / 0, 1, 1,-1,-1, 1, 1/
      DATA (NHEL(I,  35),I=1,7) / 0, 1, 1,-1,-1,-1,-1/
      DATA (NHEL(I,  36),I=1,7) / 0, 1, 1,-1,-1,-1, 1/
      DATA (NHEL(I,  37),I=1,7) / 0, 1, 1,-1, 1, 1,-1/
      DATA (NHEL(I,  38),I=1,7) / 0, 1, 1,-1, 1, 1, 1/
      DATA (NHEL(I,  39),I=1,7) / 0, 1, 1,-1, 1,-1,-1/
      DATA (NHEL(I,  40),I=1,7) / 0, 1, 1,-1, 1,-1, 1/
      DATA (NHEL(I,  41),I=1,7) / 0, 1, 1, 1,-1, 1,-1/
      DATA (NHEL(I,  42),I=1,7) / 0, 1, 1, 1,-1, 1, 1/
      DATA (NHEL(I,  43),I=1,7) / 0, 1, 1, 1,-1,-1,-1/
      DATA (NHEL(I,  44),I=1,7) / 0, 1, 1, 1,-1,-1, 1/
      DATA (NHEL(I,  45),I=1,7) / 0, 1, 1, 1, 1, 1,-1/
      DATA (NHEL(I,  46),I=1,7) / 0, 1, 1, 1, 1, 1, 1/
      DATA (NHEL(I,  47),I=1,7) / 0, 1, 1, 1, 1,-1,-1/
      DATA (NHEL(I,  48),I=1,7) / 0, 1, 1, 1, 1,-1, 1/
      DATA (NHEL(I,  49),I=1,7) / 0, 1,-1,-1,-1, 1,-1/
      DATA (NHEL(I,  50),I=1,7) / 0, 1,-1,-1,-1, 1, 1/
      DATA (NHEL(I,  51),I=1,7) / 0, 1,-1,-1,-1,-1,-1/
      DATA (NHEL(I,  52),I=1,7) / 0, 1,-1,-1,-1,-1, 1/
      DATA (NHEL(I,  53),I=1,7) / 0, 1,-1,-1, 1, 1,-1/
      DATA (NHEL(I,  54),I=1,7) / 0, 1,-1,-1, 1, 1, 1/
      DATA (NHEL(I,  55),I=1,7) / 0, 1,-1,-1, 1,-1,-1/
      DATA (NHEL(I,  56),I=1,7) / 0, 1,-1,-1, 1,-1, 1/
      DATA (NHEL(I,  57),I=1,7) / 0, 1,-1, 1,-1, 1,-1/
      DATA (NHEL(I,  58),I=1,7) / 0, 1,-1, 1,-1, 1, 1/
      DATA (NHEL(I,  59),I=1,7) / 0, 1,-1, 1,-1,-1,-1/
      DATA (NHEL(I,  60),I=1,7) / 0, 1,-1, 1,-1,-1, 1/
      DATA (NHEL(I,  61),I=1,7) / 0, 1,-1, 1, 1, 1,-1/
      DATA (NHEL(I,  62),I=1,7) / 0, 1,-1, 1, 1, 1, 1/
      DATA (NHEL(I,  63),I=1,7) / 0, 1,-1, 1, 1,-1,-1/
      DATA (NHEL(I,  64),I=1,7) / 0, 1,-1, 1, 1,-1, 1/
      DATA IDEN/ 2/
...
C     Needed for v4 models
      ...
      DOUBLE PRECISION FK_MDL_WNEU1
      DOUBLE PRECISION FK_MDL_WH01
      DOUBLE PRECISION FK_MDL_WNEUD
      DOUBLE PRECISION FK_MDL_WAD
      SAVE FK_ZERO
      SAVE FK_MDL_WNEU1
      SAVE FK_MDL_WH01
      SAVE FK_MDL_WNEUD
...
C     ----------
     ...
     $   *SMALL_WIDTH_TREATMENT)), MDL_WH01)
        FK_MDL_WAD = SIGN(MAX(ABS(MDL_WAD), ABS(MDL_MAD
     $   *SMALL_WIDTH_TREATMENT)), MDL_WAD)
        FK_ZERO = SIGN(MAX(ABS(ZERO), ABS(MDL_MM*SMALL_WIDTH_TREATMENT)
     $   ), ZERO)
        FK_MDL_WNEU1 = SIGN(MAX(ABS(MDL_WNEU1), ABS(MDL_MNEU1
     $   *SMALL_WIDTH_TREATMENT)), MDL_WNEU1)
        FK_MDL_WNEUD = SIGN(MAX(ABS(MDL_WNEUD), ABS(MDL_MNEUD
     $   *SMALL_WIDTH_TREATMENT)), MDL_WNEUD)
      ENDIF


      CALL SXXXXX(P(0,1),-1*IC(1),W(1,1))
      CALL IXXXXX(P(0,2),MDL_MNEUD,NHEL(2),-1*IC(2),W(1,2))
      CALL IXXXXX(P(0,3),MDL_MM,NHEL(3),-1*IC(3),W(1,3))
      CALL OXXXXX(P(0,4),MDL_MM,NHEL(4),+1*IC(4),W(1,4))
      CALL FFV1_3(W(1,3),W(1,4),GC_11,MDL_MAD, FK_MDL_WAD,W(1,5))
      CALL FFV1_2(W(1,2),W(1,5),GC_10,MDL_MNEU1, FK_MDL_WNEU1,W(1,4))
      CALL OXXXXX(P(0,5),MDL_MNEUD,NHEL(5),+1*IC(5),W(1,5))
      CALL IXXXXX(P(0,6),MDL_MM,NHEL(6),-1*IC(6),W(1,2))
      CALL OXXXXX(P(0,7),MDL_MM,NHEL(7),+1*IC(7),W(1,3))
      CALL FFV1_3(W(1,2),W(1,3),GC_11,MDL_MAD, FK_MDL_WAD,W(1,6))
      CALL FFV1C1_1(W(1,5),W(1,6),GC_10,MDL_MNEU1, FK_MDL_WNEU1,W(1,3))
C     Amplitude(s) for diagram number 1
      CALL FFS1_2_0(W(1,4),W(1,3),W(1,1),GC_15483,GC_15229,AMP(1))
