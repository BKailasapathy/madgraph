...
V_50 = Vertex(name = 'V_50',
              particles = [ P.uv__tilde__, P.c, P.p2 ],
              color = [ 'Identity(1,2)' ],
              lorentz = [ L.FFS1 ],
              couplings = {(0,0):C.GC_78})

V_51 = Vertex(name = 'V_51',
              particles = [ P.uv__tilde__, P.t, P.p2 ],
              color = [ 'Identity(1,2)' ],
              lorentz = [ L.FFS1 ],
...
V_53 = Vertex(name = 'V_53',
              particles = [ P.ev__tilde__, P.mu__minus__, P.p2 ],
              color = [ '1' ],
              lorentz = [ L.FFS1 ],
              couplings = {(0,0):C.GC_81})

V_54 = Vertex(name = 'V_54',
              particles = [ P.ev__tilde__, P.ta__minus__, P.p2 ],
              color = [ '1' ],
              lorentz = [ L.FFS1 ],
...
V_56 = Vertex(name = 'V_56',
              particles = [ P.uv__tilde__, P.c, P.p1 ],
              color = [ 'Identity(1,2)' ],
              lorentz = [ L.FFS1 ],
              couplings = {(0,0):C.GC_72})

V_57 = Vertex(name = 'V_57',
              particles = [ P.uv__tilde__, P.t, P.p1 ],
              color = [ 'Identity(1,2)' ],
              lorentz = [ L.FFS1 ],
...
V_59 = Vertex(name = 'V_59',
              particles = [ P.ev__tilde__, P.mu__minus__, P.p1 ],
              color = [ '1' ],
              lorentz = [ L.FFS1 ],
              couplings = {(0,0):C.GC_75})

V_60 = Vertex(name = 'V_60',
              particles = [ P.ev__tilde__, P.ta__minus__, P.p1 ],
              color = [ '1' ],
              lorentz = [ L.FFS1 ],
...
V_62 = Vertex(name = 'V_62',
              particles = [ P.c__tilde__, P.uv, P.p2 ],
              color = [ 'Identity(1,2)' ],
              lorentz = [ L.FFS2 ],
              couplings = {(0,0):C.GC_78})

V_63 = Vertex(name = 'V_63',
              particles = [ P.t__tilde__, P.uv, P.p2 ],
              color = [ 'Identity(1,2)' ],
              lorentz = [ L.FFS2 ],
              couplings = {(0,0):C.GC_79})
...
V_65 = Vertex(name = 'V_65',
              particles = [ P.mu__plus__, P.ev, P.p2 ],
              color = [ '1' ],
              lorentz = [ L.FFS2 ],
              couplings = {(0,0):C.GC_81})

V_66 = Vertex(name = 'V_66',
              particles = [ P.ta__plus__, P.ev, P.p2 ],
              color = [ '1' ],
              lorentz = [ L.FFS2 ],
              couplings = {(0,0):C.GC_82})
...
V_68 = Vertex(name = 'V_68',
              particles = [ P.c__tilde__, P.uv, P.p1 ],
              color = [ 'Identity(1,2)' ],
              lorentz = [ L.FFS2 ],
              couplings = {(0,0):C.GC_72})

V_69 = Vertex(name = 'V_69',
              particles = [ P.t__tilde__, P.uv, P.p1 ],
              color = [ 'Identity(1,2)' ],
              lorentz = [ L.FFS2 ],
              couplings = {(0,0):C.GC_73})
...
V_71 = Vertex(name = 'V_71',
              particles = [ P.mu__plus__, P.ev, P.p1 ],
              color = [ '1' ],
              lorentz = [ L.FFS2 ],
              couplings = {(0,0):C.GC_75})

V_72 = Vertex(name = 'V_72',
              particles = [ P.ta__plus__, P.ev, P.p1 ],
              color = [ '1' ],
              lorentz = [ L.FFS2 ],
              couplings = {(0,0):C.GC_76})
