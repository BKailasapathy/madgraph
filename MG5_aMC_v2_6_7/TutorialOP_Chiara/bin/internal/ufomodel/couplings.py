...
GC_73 = Coupling(name = 'GC_73',
                 value = 'complex(0,1)*lam2*cmath.cos(th) - complex(0,1)*lam1*cmath.sin(th)',
                 order = {'NP':1})

GC_74 = Coupling(name = 'GC_74',
                 value = 'complex(0,1)*lam2*cmath.cos(th) - complex(0,1)*lam1p*cmath.sin(th)',
                 order = {'NP':1})

GC_75 = Coupling(name = 'GC_75',
                 value = 'complex(0,1)*lam1*cmath.cos(th) + complex(0,1)*lam2*cmath.sin(th)',
                 order = {'NP':1})

GC_76 = Coupling(name = 'GC_76',
                 value = 'complex(0,1)*lam1p*cmath.cos(th) + complex(0,1)*lam2*cmath.sin(th)',
                 order = {'NP':1})
