...
class user : public AnalyzerBase
{
 ...
 private : 
  ...
  std::vector<const MCParticleFormat*> _P_uv_I1I_PTorderingfinalstate_REG_;
  std::vector<const MCParticleFormat*> _P_uv_t_I1I_PTorderingfinalstate_REG_;
  std::vector<const MCParticleFormat*> _P_uvPTorderingfinalstate_REG_;
  bool isP__uvPTorderingfinalstate(const MCParticleFormat* part) const {
